...
import org.mmocore.gameserver.network.l2.c2s.*;
						...
						case 0xd0:
							...
							switch(id3)
							{
								...
								case 0x8D:
									...
									break;
								case 0x8E:
									msg = new RequestExBR_MiniGameLoadScores();
									break;
								case 0x8F:
									msg = new RequestExBR_MiniGameInsertScore();
									break;
								case 0x90:
