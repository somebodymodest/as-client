...
public class AntispamAPI {
    ...
    public static final void sendPacketData(long sessionId, int direction, ByteBuffer pkt, int size) {
        AntispamAPI_Impl.sendPacketData(sessionId, direction, pkt, size);
    }
